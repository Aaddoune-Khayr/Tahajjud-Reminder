...
/// Khayr app color palette - Violet & White spiritual theme
class LightModeColors {
  // Primary: Elegant violet for spiritual ambiance
  ...
  // Tertiary: Deep night blue
  static const lightTertiary = Color(0xFF1E1B4B);
  ...
  // Surface and background: Pure white for clarity
...
/// Khayr dark mode - Deep night theme with violet accents
class DarkModeColors {
  // Primary: Soft violet glow for night
  ...
  // Tertiary: Light lavender
  static const darkTertiary = Color(0xFFDDD6FE);
  static const darkOnTertiary = Color(0xFF312E81);
  ...
  // Surface and background: Deep night
  static const darkSurface = Color(0xFF0F0E1A);
  static const darkOnSurface = Color(0xFFF5F5F5);
  static const darkSurfaceVariant = Color(0xFF1E1B4B);
...
ThemeData get lightTheme => ThemeData(
  ...
  cardTheme: CardThemeData(
    elevation: 2,
    shadowColor: LightModeColors.lightShadow.withValues(alpha: 0.08),
